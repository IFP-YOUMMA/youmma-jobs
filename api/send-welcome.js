// Vercel Serverless Function — SMS bienvenue après validation artisan
...
module.exports = async function(req, res) {
  ...
  const message =
    'Bonjour ' + prenom + ' ! ' +
    'Votre profil YOUMMA JOBS est valide. ' +
    'Vous etes maintenant visible par des clients a Conakry. ' +
    'Connectez-vous sur yoummajobs.com ' +
    'Support: +224 612 52 52 10';
  ...
  console.log('[Welcome SMS] Destinataire :', e164, '| Prénom :', prenom);
  ...
  return new Promise(function(resolve) {
    ...
    const apiReq = https.request(options, function(apiRes) {
      ...
      apiRes.on('end', function() {
        console.log('[Welcome SMS] Statut HTTP :', apiRes.statusCode);
        console.log('[Welcome SMS] Réponse     :', data);
        let parsed = null;
    ...
    apiReq.on('error', function(e) {
      console.error('[Welcome SMS] Erreur réseau :', e.message);
