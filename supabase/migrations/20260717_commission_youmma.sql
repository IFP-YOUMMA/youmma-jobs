...
-- moi-même.
--
-- CONTEXTE : le calcul de la commission (5% du total versé sur un
...
-- taux (modifiable par chantier, 5% par défaut) et l'état de paiement
...
-- silencieusement sur taux=5%/non payée sans jamais planter.
-- ═══════════════════════════════════════════════════════════════════════════
...
ALTER TABLE chantiers
  ADD COLUMN IF NOT EXISTS commission_taux NUMERIC DEFAULT 5,
...
--    - commission_taux NUMERIC DEFAULT 5 (pourcentage, modifiable par
